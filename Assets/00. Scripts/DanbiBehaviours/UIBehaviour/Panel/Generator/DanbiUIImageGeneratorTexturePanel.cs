...
#pragma warning disable 3001
    public class DanbiUIImageGeneratorTexturePanel : DanbiUIPanelControl
    {
        ...
        [SerializeField]
        List<Texture2D> m_loadedTextures;
        ...
        public delegate void OnTextureTypeChange(EDanbiTextureType type);
        public static OnTextureTypeChange onTextureTypeChange;

        public delegate void OnTexturesChange(List<Texture2D> tex, EDanbiTextureType texType);
        public static OnTexturesChange onTexturesChange;
        ...
        protected override void AddListenerForPanelFields()
        {
            ...
            textureTypeDropdown.AddOptions(new List<string> { "Regular", "360 Image", "4 Faces" });
        ...
        IEnumerator Coroutine_SelectTargetTexture(string texPath, int idx)
        {
            ...
            ++m_usedTextures;
            onTexturesChange?.Invoke(m_loadedTextures, m_textureType);
        }
