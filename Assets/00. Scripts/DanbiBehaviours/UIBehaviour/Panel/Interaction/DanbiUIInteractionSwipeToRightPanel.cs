...
namespace Danbi
{
    public class DanbiUIInteractionSwipeToRightPanel : DanbiUIPanelControl
    {
        [Readonly]
        ...
        {
            PlayerPrefs.SetFloat("InteractionSwipeToRight-detectionSensitivity", detectionSensitivity);
        }

        protected override void LoadPreviousValues(params Selectable[] uiElements)
        {
            var prevDetectionSensitivity = PlayerPrefs.GetFloat("InteractionSwipeToRight-detectionSensitivity", default);
