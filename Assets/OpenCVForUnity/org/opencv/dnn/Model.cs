...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class Model : Net
    {
        ...
        // internal usage only
        public static new Model __fromPtr__(IntPtr addr) { return new Model(addr); }
        ...
        public Model(Net network) :
            base(dnn_Model_Model_10(network.nativeObj))
        {
        ...
        public Model(string model, string config) :
            base(dnn_Model_Model_11(model, config))
        {
        ...
        public Model setInputCrop(bool crop)
        {
            ...
            return new Model(dnn_Model_setInputCrop_10(nativeObj, crop));
        ...
        public Model setInputMean(Scalar mean)
        {
            ...
            return new Model(dnn_Model_setInputMean_10(nativeObj, mean.val[0], mean.val[1], mean.val[2], mean.val[3]));
        ...
        public Model setInputScale(double scale)
        {
            ...
            return new Model(dnn_Model_setInputScale_10(nativeObj, scale));
        ...
        public Model setInputSize(Size size)
        {
            ...
            return new Model(dnn_Model_setInputSize_10(nativeObj, size.width, size.height));
        ...
        public Model setInputSize(int width, int height)
        {
            ...
            return new Model(dnn_Model_setInputSize_11(nativeObj, width, height));
        ...
        public Model setInputSwapRB(bool swapRB)
        {
            ...
            return new Model(dnn_Model_setInputSwapRB_10(nativeObj, swapRB));
        ...
        // C++:   cv::dnn::Model::Model(Net network)
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_Model_Model_10(IntPtr network_nativeObj);

        // C++:   cv::dnn::Model::Model(String model, String config = "")
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_Model_Model_11(string model, string config);
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_Model_Model_12(string model);
