...
namespace OpenCVForUnity.MlModule
{
    ...
    public class SVMSGD : StatModel
    {
        ...
        public Mat getWeights()
        {
            ...
            return new Mat(ml_SVMSGD_getWeights_10(nativeObj));
        ...
        public static SVMSGD load(string filepath, string nodeName)
        {
            ...
            return SVMSGD.__fromPtr__(ml_SVMSGD_load_10(filepath, nodeName));
        ...
        public static SVMSGD load(string filepath)
        {
            ...
            return SVMSGD.__fromPtr__(ml_SVMSGD_load_11(filepath));
