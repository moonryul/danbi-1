        ...
        public static void UseUnsafeCode()
        {
            ...
            if (Menu.GetChecked("Tools/OpenCV for Unity/Use Unsafe Code"))
            {
                ...
                "Do you want to disable Unsafe Code in OpenCV for Unity?", "Yes", "Cancel"))
                {
                    ...
                    Debug.Log("PlayerSettings.allowUnsafeCode has been set to " + PlayerSettings.allowUnsafeCode + " and \"" + SYMBOL_OPENCV_USE_UNSAFE_CODE + "\" has been removed from Scripting Define Symbols.");
                }
            }
            else
            {
                ...
                "Do you want to enable Unsafe Code in OpenCV for Unity?", "Yes", "Cancel"))
                {
                    ...
                    Debug.Log("PlayerSettings.allowUnsafeCode has been set to " + PlayerSettings.allowUnsafeCode + " and \"" + SYMBOL_OPENCV_USE_UNSAFE_CODE + "\" has been added to Scripting Define Symbols.");
                }
            }
