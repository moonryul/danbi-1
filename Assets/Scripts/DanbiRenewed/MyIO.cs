...
public class MyIO {
  ...
  public static void DebugLog(float num) {
    //UnityEngine.Debug.LogFormat("Number: {0}, string: {1}, number again: {0}, character: {2}", num, str, chr);
    UnityEngine.Debug.Log(num.ToString("F4"));
  ...
  public static void DebugLogVector(Vector2 vector) {
  ...
  public static void DebugLogVector(Vector4 vector) {
  ...
  [System.Diagnostics.Conditional("UNITY_EDITOR")]
  [System.Diagnostics.Conditional("TRACE_ON")]
  public static void DebugLogMatrix(Matrix4x4 mat)     // struct Matrix4x4 mat; mat[i,j]
  {
    int rowLength = 4;
    int colLength = 4;
    string arrayString = "";
