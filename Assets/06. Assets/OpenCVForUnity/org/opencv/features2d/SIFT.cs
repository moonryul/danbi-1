...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class SIFT : Feature2D
    {
        ...
        public static SIFT create(int nfeatures, int nOctaveLayers, double contrastThreshold, double edgeThreshold, double sigma)
        {
            ...
            return SIFT.__fromPtr__(features2d_SIFT_create_10(nfeatures, nOctaveLayers, contrastThreshold, edgeThreshold, sigma));
        ...
        public static SIFT create(int nfeatures, int nOctaveLayers, double contrastThreshold, double edgeThreshold)
        {
            ...
            return SIFT.__fromPtr__(features2d_SIFT_create_11(nfeatures, nOctaveLayers, contrastThreshold, edgeThreshold));
        ...
        public static SIFT create(int nfeatures, int nOctaveLayers, double contrastThreshold)
        {
            ...
            return SIFT.__fromPtr__(features2d_SIFT_create_12(nfeatures, nOctaveLayers, contrastThreshold));
        ...
        public static SIFT create(int nfeatures, int nOctaveLayers)
        {
            ...
            return SIFT.__fromPtr__(features2d_SIFT_create_13(nfeatures, nOctaveLayers));
        ...
        public static SIFT create(int nfeatures)
        {
            ...
            return SIFT.__fromPtr__(features2d_SIFT_create_14(nfeatures));
        ...
        public static SIFT create()
        {
            ...
            return SIFT.__fromPtr__(features2d_SIFT_create_15());
        ...
        public override string getDefaultName()
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(features2d_SIFT_getDefaultName_10(nativeObj));
