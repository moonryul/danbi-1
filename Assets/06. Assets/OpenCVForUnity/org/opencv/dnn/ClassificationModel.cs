...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class ClassificationModel : Model
    {
        ...
        public ClassificationModel(Net network) :
            base(dnn_ClassificationModel_ClassificationModel_10(network.nativeObj))
        {
        ...
        public ClassificationModel(string model, string config) :
            base(dnn_ClassificationModel_ClassificationModel_11(model, config))
        {
        ...
        public ClassificationModel(string model) :
            base(dnn_ClassificationModel_ClassificationModel_12(model))
        {
        ...
        // C++:   cv::dnn::ClassificationModel::ClassificationModel(Net network)
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_ClassificationModel_ClassificationModel_10(IntPtr network_nativeObj);

        // C++:   cv::dnn::ClassificationModel::ClassificationModel(String model, String config = "")
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_ClassificationModel_ClassificationModel_11(string model, string config);
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_ClassificationModel_ClassificationModel_12(string model);
