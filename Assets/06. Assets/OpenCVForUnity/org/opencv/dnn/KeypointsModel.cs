...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class KeypointsModel : Model
    {
        ...
        public KeypointsModel(Net network) :
            base(dnn_KeypointsModel_KeypointsModel_10(network.nativeObj))
        {
        ...
        public KeypointsModel(string model, string config) :
            base(dnn_KeypointsModel_KeypointsModel_11(model, config))
        {
        ...
        public KeypointsModel(string model) :
            base(dnn_KeypointsModel_KeypointsModel_12(model))
        {
        ...
        public MatOfPoint2f estimate(Mat frame, float thresh)
        {
            ...
            return MatOfPoint2f.fromNativeAddr(dnn_KeypointsModel_estimate_10(nativeObj, frame.nativeObj, thresh));
        ...
        // C++:   cv::dnn::KeypointsModel::KeypointsModel(Net network)
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_KeypointsModel_KeypointsModel_10(IntPtr network_nativeObj);

        // C++:   cv::dnn::KeypointsModel::KeypointsModel(String model, String config = "")
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_KeypointsModel_KeypointsModel_11(string model, string config);
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_KeypointsModel_KeypointsModel_12(string model);
