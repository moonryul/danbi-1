...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class SegmentationModel : Model
    {
        ...
        public SegmentationModel(Net network) :
            base(dnn_SegmentationModel_SegmentationModel_10(network.nativeObj))
        {
        ...
        public SegmentationModel(string model, string config) :
            base(dnn_SegmentationModel_SegmentationModel_11(model, config))
        {
        ...
        public SegmentationModel(string model) :
            base(dnn_SegmentationModel_SegmentationModel_12(model))
        {
        ...
        // C++:   cv::dnn::SegmentationModel::SegmentationModel(Net network)
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_SegmentationModel_SegmentationModel_10(IntPtr network_nativeObj);

        // C++:   cv::dnn::SegmentationModel::SegmentationModel(String model, String config = "")
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_SegmentationModel_SegmentationModel_11(string model, string config);
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_SegmentationModel_SegmentationModel_12(string model);
