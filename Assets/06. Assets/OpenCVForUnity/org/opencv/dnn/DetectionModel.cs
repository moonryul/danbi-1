...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class DetectionModel : Model
    {
        ...
        public DetectionModel(Net network) :
            base(dnn_DetectionModel_DetectionModel_10(network.nativeObj))
        {
        ...
        public DetectionModel(string model, string config) :
            base(dnn_DetectionModel_DetectionModel_11(model, config))
        {
        ...
        public DetectionModel(string model) :
            base(dnn_DetectionModel_DetectionModel_12(model))
        {
        ...
        // C++:   cv::dnn::DetectionModel::DetectionModel(Net network)
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_DetectionModel_DetectionModel_10(IntPtr network_nativeObj);

        // C++:   cv::dnn::DetectionModel::DetectionModel(String model, String config = "")
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_DetectionModel_DetectionModel_11(string model, string config);
        [DllImport(LIBNAME)]
        private static extern IntPtr dnn_DetectionModel_DetectionModel_12(string model);
