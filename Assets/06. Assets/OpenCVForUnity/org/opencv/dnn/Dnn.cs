...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class Dnn
    {
        ...
        public static Mat blobFromImage(Mat image, double scalefactor, Size size, Scalar mean, bool swapRB, bool crop, int ddepth)
        {
            ...
            return new Mat(dnn_Dnn_blobFromImage_10(image.nativeObj, scalefactor, size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB, crop, ddepth));
        ...
        public static Mat blobFromImage(Mat image, double scalefactor, Size size, Scalar mean, bool swapRB, bool crop)
        {
            ...
            return new Mat(dnn_Dnn_blobFromImage_11(image.nativeObj, scalefactor, size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB, crop));
        ...
        public static Mat blobFromImage(Mat image, double scalefactor, Size size, Scalar mean, bool swapRB)
        {
            ...
            return new Mat(dnn_Dnn_blobFromImage_12(image.nativeObj, scalefactor, size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB));
        ...
        public static Mat blobFromImage(Mat image, double scalefactor, Size size, Scalar mean)
        {
            ...
            return new Mat(dnn_Dnn_blobFromImage_13(image.nativeObj, scalefactor, size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3]));
        ...
        public static Mat blobFromImage(Mat image, double scalefactor, Size size)
        {
            ...
            return new Mat(dnn_Dnn_blobFromImage_14(image.nativeObj, scalefactor, size.width, size.height));
        ...
        public static Mat blobFromImage(Mat image, double scalefactor)
        {
            ...
            return new Mat(dnn_Dnn_blobFromImage_15(image.nativeObj, scalefactor));
        ...
        public static Mat blobFromImage(Mat image)
        {
            ...
            return new Mat(dnn_Dnn_blobFromImage_16(image.nativeObj));
        ...
        public static Mat blobFromImages(List<Mat> images, double scalefactor, Size size, Scalar mean, bool swapRB, bool crop, int ddepth)
        {
            ...
            return new Mat(dnn_Dnn_blobFromImages_10(images_mat.nativeObj, scalefactor, size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB, crop, ddepth));
        ...
        public static Mat blobFromImages(List<Mat> images, double scalefactor, Size size, Scalar mean, bool swapRB, bool crop)
        {
            ...
            Mat images_mat = Converters.vector_Mat_to_Mat(images);
            return new Mat(dnn_Dnn_blobFromImages_11(images_mat.nativeObj, scalefactor, size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB, crop));
        ...
        public static Mat blobFromImages(List<Mat> images, double scalefactor, Size size, Scalar mean, bool swapRB)
        {
            ...
            Mat images_mat = Converters.vector_Mat_to_Mat(images);
            return new Mat(dnn_Dnn_blobFromImages_12(images_mat.nativeObj, scalefactor, size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB));
        ...
        public static Mat blobFromImages(List<Mat> images, double scalefactor, Size size, Scalar mean)
        {
            ...
            Mat images_mat = Converters.vector_Mat_to_Mat(images);
            return new Mat(dnn_Dnn_blobFromImages_13(images_mat.nativeObj, scalefactor, size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3]));
        ...
        public static Mat blobFromImages(List<Mat> images, double scalefactor, Size size)
        {
            ...
            Mat images_mat = Converters.vector_Mat_to_Mat(images);
            return new Mat(dnn_Dnn_blobFromImages_14(images_mat.nativeObj, scalefactor, size.width, size.height));
        ...
        public static Mat blobFromImages(List<Mat> images, double scalefactor)
        {
            ...
            Mat images_mat = Converters.vector_Mat_to_Mat(images);
            return new Mat(dnn_Dnn_blobFromImages_15(images_mat.nativeObj, scalefactor));
        ...
        public static Mat blobFromImages(List<Mat> images)
        {
            ...
            Mat images_mat = Converters.vector_Mat_to_Mat(images);
            return new Mat(dnn_Dnn_blobFromImages_16(images_mat.nativeObj));
        ...
        public static Mat readTensorFromONNX(string path)
        {
            ...
            return new Mat(dnn_Dnn_readTensorFromONNX_10(path));
        ...
        public static Mat readTorchBlob(string filename, bool isBinary)
        {
            ...
            return new Mat(dnn_Dnn_readTorchBlob_10(filename, isBinary));
        ...
        public static Mat readTorchBlob(string filename)
        {
            ...
            return new Mat(dnn_Dnn_readTorchBlob_11(filename));
        ...
        public static Net readNet(string framework, MatOfByte bufferModel, MatOfByte bufferConfig)
        {
            ...
            return new Net(dnn_Dnn_readNet_10(framework, bufferModel_mat.nativeObj, bufferConfig_mat.nativeObj));
        ...
        public static Net readNet(string framework, MatOfByte bufferModel)
        {
            if (bufferModel != null) bufferModel.ThrowIfDisposed();
            Mat bufferModel_mat = bufferModel;
            return new Net(dnn_Dnn_readNet_11(framework, bufferModel_mat.nativeObj));
        ...
        public static Net readNet(string model, string config, string framework)
        {
            ...
            return new Net(dnn_Dnn_readNet_12(model, config, framework));
        ...
        public static Net readNet(string model, string config)
        {
            ...
            return new Net(dnn_Dnn_readNet_13(model, config));
        ...
        public static Net readNet(string model)
        {
            ...
            return new Net(dnn_Dnn_readNet_14(model));
        ...
        public static Net readNetFromCaffe(string prototxt, string caffeModel)
        {
            ...
            return new Net(dnn_Dnn_readNetFromCaffe_10(prototxt, caffeModel));
        ...
        public static Net readNetFromCaffe(string prototxt)
        {
            ...
            return new Net(dnn_Dnn_readNetFromCaffe_11(prototxt));
        ...
        public static Net readNetFromCaffe(MatOfByte bufferProto, MatOfByte bufferModel)
        {
            ...
            Mat bufferModel_mat = bufferModel;
            return new Net(dnn_Dnn_readNetFromCaffe_12(bufferProto_mat.nativeObj, bufferModel_mat.nativeObj));
        ...
        public static Net readNetFromCaffe(MatOfByte bufferProto)
        {
            if (bufferProto != null) bufferProto.ThrowIfDisposed();
            Mat bufferProto_mat = bufferProto;
            return new Net(dnn_Dnn_readNetFromCaffe_13(bufferProto_mat.nativeObj));
        ...
        public static Net readNetFromDarknet(string cfgFile, string darknetModel)
        {
            ...
            return new Net(dnn_Dnn_readNetFromDarknet_10(cfgFile, darknetModel));
        ...
        public static Net readNetFromDarknet(string cfgFile)
        {
            ...
            return new Net(dnn_Dnn_readNetFromDarknet_11(cfgFile));
        ...
        public static Net readNetFromDarknet(MatOfByte bufferCfg, MatOfByte bufferModel)
        {
            ...
            Mat bufferModel_mat = bufferModel;
            return new Net(dnn_Dnn_readNetFromDarknet_12(bufferCfg_mat.nativeObj, bufferModel_mat.nativeObj));
        ...
        public static Net readNetFromDarknet(MatOfByte bufferCfg)
        {
            if (bufferCfg != null) bufferCfg.ThrowIfDisposed();
            Mat bufferCfg_mat = bufferCfg;
            return new Net(dnn_Dnn_readNetFromDarknet_13(bufferCfg_mat.nativeObj));
        ...
        public static Net readNetFromModelOptimizer(string xml, string bin)
        {
            ...
            return new Net(dnn_Dnn_readNetFromModelOptimizer_10(xml, bin));
        ...
        public static Net readNetFromModelOptimizer(MatOfByte bufferModelConfig, MatOfByte bufferWeights)
        {
            ...
            return new Net(dnn_Dnn_readNetFromModelOptimizer_11(bufferModelConfig_mat.nativeObj, bufferWeights_mat.nativeObj));
        ...
        public static Net readNetFromONNX(string onnxFile)
        {
            ...
            return new Net(dnn_Dnn_readNetFromONNX_10(onnxFile));
        ...
        public static Net readNetFromONNX(MatOfByte buffer)
        {
            ...
            return new Net(dnn_Dnn_readNetFromONNX_11(buffer_mat.nativeObj));
        ...
        public static Net readNetFromTensorflow(string model, string config)
        {
            ...
            return new Net(dnn_Dnn_readNetFromTensorflow_10(model, config));
        ...
        public static Net readNetFromTensorflow(string model)
        {
            ...
            return new Net(dnn_Dnn_readNetFromTensorflow_11(model));
        ...
        public static Net readNetFromTensorflow(MatOfByte bufferModel, MatOfByte bufferConfig)
        {
            ...
            Mat bufferModel_mat = bufferModel;
            Mat bufferConfig_mat = bufferConfig;
            return new Net(dnn_Dnn_readNetFromTensorflow_12(bufferModel_mat.nativeObj, bufferConfig_mat.nativeObj));
        ...
        public static Net readNetFromTensorflow(MatOfByte bufferModel)
        {
            if (bufferModel != null) bufferModel.ThrowIfDisposed();
            Mat bufferModel_mat = bufferModel;
            return new Net(dnn_Dnn_readNetFromTensorflow_13(bufferModel_mat.nativeObj));
        ...
        public static Net readNetFromTorch(string model, bool isBinary, bool evaluate)
        {
            ...
            return new Net(dnn_Dnn_readNetFromTorch_10(model, isBinary, evaluate));
        ...
        public static Net readNetFromTorch(string model, bool isBinary)
        {
            ...
            return new Net(dnn_Dnn_readNetFromTorch_11(model, isBinary));
        ...
        public static Net readNetFromTorch(string model)
        {
            ...
            return new Net(dnn_Dnn_readNetFromTorch_12(model));
        ...
        public static string getInferenceEngineBackendType()
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(dnn_Dnn_getInferenceEngineBackendType_10());
        ...
        public static string setInferenceEngineBackendType(string newBackendType)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(dnn_Dnn_setInferenceEngineBackendType_10(newBackendType));
        ...
        public static List<int> getAvailableTargets(int be)
        {
            ...
            Mat retValMat = new Mat(dnn_Dnn_getAvailableTargets_10(be));
