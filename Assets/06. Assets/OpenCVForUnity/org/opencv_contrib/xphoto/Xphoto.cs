...
namespace OpenCVForUnity.XphotoModule
{
    ...
    public class Xphoto
    {
        ...
        public static GrayworldWB createGrayworldWB()
        {
            ...
            return GrayworldWB.__fromPtr__(xphoto_Xphoto_createGrayworldWB_10());
        ...
        public static LearningBasedWB createLearningBasedWB(string path_to_model)
        {
            ...
            return LearningBasedWB.__fromPtr__(xphoto_Xphoto_createLearningBasedWB_10(path_to_model));
        ...
        public static LearningBasedWB createLearningBasedWB()
        {
            ...
            return LearningBasedWB.__fromPtr__(xphoto_Xphoto_createLearningBasedWB_11());
        ...
        public static SimpleWB createSimpleWB()
        {
            ...
            return SimpleWB.__fromPtr__(xphoto_Xphoto_createSimpleWB_10());
        ...
        public static TonemapDurand createTonemapDurand(float gamma, float contrast, float saturation, float sigma_color, float sigma_space)
        {
            ...
            return TonemapDurand.__fromPtr__(xphoto_Xphoto_createTonemapDurand_10(gamma, contrast, saturation, sigma_color, sigma_space));
        ...
        public static TonemapDurand createTonemapDurand(float gamma, float contrast, float saturation, float sigma_color)
        {
            ...
            return TonemapDurand.__fromPtr__(xphoto_Xphoto_createTonemapDurand_11(gamma, contrast, saturation, sigma_color));
        ...
        public static TonemapDurand createTonemapDurand(float gamma, float contrast, float saturation)
        {
            ...
            return TonemapDurand.__fromPtr__(xphoto_Xphoto_createTonemapDurand_12(gamma, contrast, saturation));
        ...
        public static TonemapDurand createTonemapDurand(float gamma, float contrast)
        {
            ...
            return TonemapDurand.__fromPtr__(xphoto_Xphoto_createTonemapDurand_13(gamma, contrast));
        ...
        public static TonemapDurand createTonemapDurand(float gamma)
        {
            ...
            return TonemapDurand.__fromPtr__(xphoto_Xphoto_createTonemapDurand_14(gamma));
        ...
        public static TonemapDurand createTonemapDurand()
        {
            ...
            return TonemapDurand.__fromPtr__(xphoto_Xphoto_createTonemapDurand_15());
