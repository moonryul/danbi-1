...
namespace OpenCVForUnity.ArucoModule
{
    ...
    public class Aruco
    {
        ...
        public static Dictionary custom_dictionary_from(int nMarkers, int markerSize, Dictionary baseDictionary, int randomSeed)
        {
            ...
            return Dictionary.__fromPtr__(aruco_Aruco_custom_1dictionary_1from_10(nMarkers, markerSize, baseDictionary.getNativeObjAddr(), randomSeed));
        ...
        public static Dictionary custom_dictionary_from(int nMarkers, int markerSize, Dictionary baseDictionary)
        {
            ...
            return Dictionary.__fromPtr__(aruco_Aruco_custom_1dictionary_1from_11(nMarkers, markerSize, baseDictionary.getNativeObjAddr()));
        ...
        public static Dictionary custom_dictionary(int nMarkers, int markerSize, int randomSeed)
        {
            ...
            return Dictionary.__fromPtr__(aruco_Aruco_custom_1dictionary_10(nMarkers, markerSize, randomSeed));
        ...
        public static Dictionary custom_dictionary(int nMarkers, int markerSize)
        {
            ...
            return Dictionary.__fromPtr__(aruco_Aruco_custom_1dictionary_11(nMarkers, markerSize));
        ...
        public static Dictionary getPredefinedDictionary(int dict)
        {
            ...
            return Dictionary.__fromPtr__(aruco_Aruco_getPredefinedDictionary_10(dict));
